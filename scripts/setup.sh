...
printf 'Then sign up at http://localhost:3000/signup to create your own\n'
printf 'workspace. The seeded `northwind` workspace belongs to a seeded user\n'
printf '(avery@northwind.example) who has no password, so you cannot sign in as\n'
printf 'them — the seed exists to give the database a realistic shape, not a\n'
printf 'login.\n\n'
