 ...
 * user, through the guards in `./guards.ts`. A workspace id posted in a form
 * field is an attacker's field, so no action here accepts one: the id it acts on
 * is the one a membership check just produced.
 */
